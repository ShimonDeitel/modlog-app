...
struct ContentView: View {
    ...
    @State private var editingItem: ModEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Custom Mod Log")
            .toolbar {
    ...
    private func editSheet(for item: ModEntry) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: ModEntry
    var onSave: (ModEntry) -> Void
    var onDelete: () -> Void
